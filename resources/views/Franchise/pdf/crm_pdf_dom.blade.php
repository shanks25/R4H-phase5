...
<body>
    <div id="tab">
        ...
        <div class="top_wrapper">
            <div class="top_sec">
                <div class="fst_sec">
                    <div class="lt_sec">{{$payor_type_title ?? ''}} Name: <span><?php echo $pdf[0]->payor_name ?></span></div>
            ...
            <div class="mid_sec">
                <div class="fst_sec">
                    <div class="lt_sec">{{$payor_type_title ?? ''}} ID (If applicable): <span>NA</span></div>
        ...
        <table style="width: 100%;">
            ...
            if ($pdf[0]->upload_signature_original) {
                ...
                $diverstyle = 'style="margin-top:8px"';
            } else {
                $dirverimg = '';
                $diverstyle = '';
            }
            ...
            foreach ($pdf as $row) {
                ...
                if ($row->member_sign != '') {
                    ...
                    $img = '';
                    if ($row->member_sign) {
                        $img = '<div style="width:auto;height:50px;"><img src="' .awsasset($row->member_sign) . '" height="50px"></div>'; //class="'.$class.'"
                    }
                ...
                $date_of_service = "12-2-22";
                $pickup_time = "12-2-22";
                $dropoff_time = "12-2-22";
            ?>
                <tr>
                    ...
                    <td>&nbsp;</td>
                    <td>$<?php echo round($row->trip_price, 4); ?></td>
                    <td><?php echo $img; ?></td>
                </tr>
            <?php } ?>
        </table>
