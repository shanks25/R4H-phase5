...
class UpdateBrokerRequest extends BrokerRequest
{
    /**
    ...
    public function rules()
    {
        ...
        $new_rules= [
            'id' => ['required', Rule::exists('provider_master', 'id,deleted_at,NULL')->where('user_id', esoId())],
    ...
    protected function failedValidation(Validator $validator) {
        $metaData = metaData('false', request(), '10001', '', '400', '', $validator->errors());
