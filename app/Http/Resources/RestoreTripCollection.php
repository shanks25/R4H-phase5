...
class RestoreTripCollection extends ResourceCollection
{
    ...
    public function map($collection)
    {
        return $collection->map(function ($item) {
            return [
                ...
                'payout' => payout($item->payout_type),
                'status_desc' => $item->status ? $item->status->status_description : '',
                'member' => $item->member,
    ...
    {
        return  metaData(true, $request, '4034', 'success', 200, '');
    }
}
